...
; BB#0:
	...
	s_add_i32 s4, s6, s4
	s_and_b32 s5, s4, 0x7ffffe0
	v_or_b32_e32 v1, v1, v0
	s_sub_i32 s5, s6, s5
	s_ashr_i32 s6, s4, 5
	v_and_b32_e32 v1, 0x1c1f, v1
	s_and_b32 s4, s4, 0xffffffe0
	v_lshrrev_b32_e32 v5, 4, v0
	v_add_i32_e32 v74, vcc, s4, v1
	s_lshl_b32 s4, s5, 5
	v_and_b32_e32 v4, 15, v0
	v_add_i32_e32 v87, vcc, s4, v1
	v_lshlrev_b32_e32 v1, 12, v5
	v_or_b32_e32 v1, v1, v4
	v_mov_b32_e32 v75, 0
	v_add_i32_e32 v1, vcc, s4, v1
	s_lshl_b32 s4, s6, 17
	v_add_i32_e32 v1, vcc, s4, v1
	...
	;;#ASMSTART
     ...
     global_load_dwordx4 v[79:82], v[2:3], off 
     
	;;#ASMEND
	v_lshlrev_b64 v[2:3], 4, v[87:88]
	v_add_i32_e32 v2, vcc, s8, v2
	v_mov_b32_e32 v6, s9
	v_addc_u32_e32 v3, vcc, v6, v3, vcc
	;;#ASMSTART
	
     global_load_dwordx4 v[83:86], v[2:3], off 
	...
	v_add_i32_e32 v10, vcc, s10, v0
	v_addc_u32_e32 v11, vcc, v1, v75, vcc
	s_mov_b32 s11, 0x8000
	v_add_i32_e32 v20, vcc, s11, v0
	v_addc_u32_e32 v21, vcc, v1, v75, vcc
	s_mov_b32 s12, 0xc000
	v_add_i32_e32 v30, vcc, s12, v0
	s_add_u32 s6, s0, 0x100000
	v_addc_u32_e32 v31, vcc, v1, v75, vcc
	s_addc_u32 s7, s1, 0
	v_add_i32_e32 v64, vcc, s6, v40
	v_mov_b32_e32 v40, s7
	v_addc_u32_e32 v65, vcc, v40, v41, vcc
	v_add_i32_e32 v44, vcc, s10, v64
	v_addc_u32_e32 v45, vcc, v65, v75, vcc
	v_add_i32_e32 v48, vcc, s11, v64
	v_addc_u32_e32 v49, vcc, v65, v75, vcc
	...
	;;#ASMEND
	v_add_i32_e32 v64, vcc, s12, v64
	v_or_b32_e32 v72, s5, v77
	v_addc_u32_e32 v65, vcc, v65, v75, vcc
	...
	;;#ASMSTART
         ...
         ds_write_b128 v78, v[79:82] 
         
	;;#ASMEND
	;;#ASMSTART
	
           ds_write_b128 v78, v[83:86] offset:4096 
...
BB0_1:                                  ; =>This Inner Loop Header: Depth=1
	...
	;;#ASMSTART
         ...
         ds_write_b128 v74, v[81:84] 
         
	;;#ASMEND
	;;#ASMSTART
	
           ds_write_b128 v74, v[85:88] offset:4096 
	...
	s_xor_b32 s5, s5, s10
	s_add_i32 s4, s4, s10
	v_add_i32_e32 v73, vcc, s11, v76
	v_add_i32_e32 v72, vcc, s5, v77
	;;#ASMSTART
