...
__global__ void SGEMM(Float4 *A, Float4 *B, Float4 *C, int *getGlobalAId, int *getGlobalCId) {
    ...
    global_load<0>(C, c[4], cid4);
    global_load<0>(C, c[5], cid5);
    global_load<0>(C, c[6], cid6);
    global_load<0>(C, c[7], cid7);
    ...
    global_load<0>(C, c[12], cid12);
    global_load<0>(C, c[13], cid13);
    global_load<0>(C, c[14], cid14);
    global_load<0>(C, c[15], cid15);
...
for(int j=0;j<yDim/8;j++) {
    ...
    global_store<0>(C, c[4], cid4);
    global_store<0>(C, c[5], cid5);
    global_store<0>(C, c[6], cid6);
    global_store<0>(C, c[7], cid7);
    ...
    global_store<0>(C, c[12], cid12);
    global_store<0>(C, c[13], cid13);
    global_store<0>(C, c[14], cid14);
    global_store<0>(C, c[15], cid15);
